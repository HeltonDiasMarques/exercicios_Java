...
Objetivo: Entender o básico da linguagem Java e iniciar a programação.

## Introdução ao Java
### Exercício 1: Primeiro Programa (Hello World)
### Exercício 2: Estrutura Básica de um Programa Java

## Variáveis e Tipos de Dados
### Exercício 3: Declaração e Uso de Variáveis
### Exercício 4: Operações Matemáticas Simples

## Entrada e Saída de Dados
### Exercício 5: Ler e Exibir Dados do Usuário

## Estruturas Condicionais
### Exercício 6: Verificação de Idade (Maior ou Menor de Idade)
### Exercício 7: Número Par ou Ímpar
### Exercício 8: Verificação de Notas (Aprovado, Reprovado)

## Operadores Lógicos e Relacionais
### Exercício 9: Uso de Operadores Relacionais e Lógicos em Decisões Simples

#### Total de Exercícios: 9

# Nível 2: Iniciante
Objetivo: Aprender estruturas de repetição e manipulação de dados sem o uso de Array. Implementar manualmente vetores e matrizes.
...
### Exercício 9: Somatório de Pares
### Exercício 10: Média Aritmética
### Exercício 11: Exibição de Caracteres
### Exercício 12: Pirâmide de Asteriscos
